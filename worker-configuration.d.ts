...
// Native rate-limiting binding shape (see wrangler.jsonc `ratelimits`). `wrangler types` emits an
// equivalent when the binding is present; declared here by hand since this file is manually maintained.
interface RateLimit {
